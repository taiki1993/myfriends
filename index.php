      ...
      <legend>都道府県一覧</legend>
        <table class="table table-striped table-bordered table-hover table-condensed">
          ...
          <tbody>
            <!-- id, 県名を表示 -->
           <?php
           foreach ($fuck as $shit) {?>
            <tr>

              <td><div class="text-center"><?php echo $shit['area_id']; ?></div></td>
              <!-- 下のやつでid番号のデータごとページを移せる -->
              <td><div class="text-center"><a href="show.php?area_id=<?php echo $shit['area_id']; ?>"><?php echo $shit['area_name']; ?></a></div></td>
